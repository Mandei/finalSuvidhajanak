                ...
                <div class=" container col-sm-12 details border">
                    ...
                    <div class"container">
                        <form action="updateAdmin.html" method="post">
                            <div class="row m-3 ">
                              <div class="col">
                                <input type="text" class="form-control border-bottom" name="firstName" placeholder="First name" value="${admin.firstName }">
                              </div>
                              <div class="col">
                                <input type="text" class="form-control border-bottom" name="lastName" placeholder="Last name" value="${admin.lastName}">
                              </div>
                            </div>
                            <div class="row mx-3">
                                <div class="col">
                                  <input type="text" class="form-control border-bottom" name="contactNumber" placeholder="Contact" value="${admin.contactNumber}">
                                </div>
                                <div class="col">
                                  <input type="text" class="form-control border-bottom" name="email" placeholder="Email" value="${admin.email}" >
                                </div>
                            </div >
                        <div class="row mx-3">
                        <div class="col mt-3">
                                  <input type="text" class="form-control border-bottom" name="pwd" placeholder="Password"  >
                                </div>
                                <div class="col ">
