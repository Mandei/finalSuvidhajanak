              ...
              <div class="sidenav sidenav-collapse  "  id="mySidenav">
               ...
               <div class="content " >
                 ...
                 <div class="jumbotron col-6 mx-auto add-service-form " >
                    ...
                    <form action="adminPanelUpdateService.html" class="col-11 mx-auto " method="post" >
                        <h2 style="position: relative; top:-25px"><b>Update Service:</b></h2>
                        <div class="form-group ">
                            <input type="text" class="form-control service-field" name="serviceName" value="${service.serviceName }" required >
                            <span class="floating-label">Service Name</span>
                        </div>
                        <div class="form-group">
                          
                         <textarea   class="form-control service-field" id="description" name="serviceDetails" value="" required >${service.serviceDetails }</textarea>
                         <span class="floating-label">Service Details</span>
                        </div>
                        <div class="form-group">
                                
                                <input type="text" class="form-control service-field" name="price" value="${service.price }" required >
