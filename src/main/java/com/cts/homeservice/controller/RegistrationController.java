...
public class RegistrationController {
	...
	public ModelAndView registerUser(@ModelAttribute User user,  HttpSession httpSession) 
	{
		...
		{
			httpSession.setAttribute("status", "registrationSuccess");
	...
	public ModelAndView registerWorker(@ModelAttribute Worker worker, HttpServletRequest request, HttpSession httpSession)
	{
		ModelAndView modelAndView=new ModelAndView();
		modelAndView.addObject("error", "");
